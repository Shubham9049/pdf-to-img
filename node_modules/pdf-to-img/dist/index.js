...
const pdfjs = _pdfjs;
const pdfjsPath = node_path_1.default.dirname(require.resolve("pdfjs-dist/package.json"));
...
function pdf(input, options = {}) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const pdfDocument = yield pdfjs.getDocument(Object.assign(Object.assign({ password: options.password, standardFontDataUrl: node_path_1.default.join(pdfjsPath, `standard_fonts${node_path_1.default.sep}`), cMapUrl: node_path_1.default.join(pdfjsPath, `cmaps${node_path_1.default.sep}`), cMapPacked: true, isEvalSupported: false }, options.docInitParams), { data })).promise;
